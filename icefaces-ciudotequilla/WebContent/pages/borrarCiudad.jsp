	...
	<f:subview id="cap">
		<jsp:include page="/pages/header.jsp" />
			...
			<h:form>
				...
				<h:outputText value="#{beanCiudad.ciudad.nombreCiudad}"/>
				<h:inputHidden value="#{beanCiudad.ciudad.idCiudad}"/>

				<br>
				<br>
				<h:commandButton value="#{msjs.borrarCiudad}" action="#{beanCiudad.delete}" />
